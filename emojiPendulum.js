...
.happy, .teary {
  animation:display .5s ease-in 1s forwards;
}
.notamused {
  animation:display .7s ease-out 3.5s forwards;
}
.angry {
  animation:display .7s ease-out 4.5s forwards;
}
.depressed {
  animation:display .7s ease-out 5.5s forwards;
}
/* animations */
@keyframes display {
  to {
